...
function iniciarContador() {
    const eventoFecha = new Date("March 29, 2025 00:00:00").getTime();
...
function confirmarAsistencia() {
    const mensaje = `Hola, confirmo mi asistencia para la boda de Amy & Héctor.`;
    const numeroTelefono = '50236737715'; // Reemplaza con el número de WhatsApp al cual se enviará el mensaje
